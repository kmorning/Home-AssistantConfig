...
from meross_iot.local_manager import MerossLocalManager
...
CONFIG_SCHEMA = vol.Schema({
    DOMAIN: vol.Schema({
        ...
        vol.Required(CONF_CERT): cv.string, #vol.Optional(CONF_CERT, default=DEFAULT_CERT): cv.string,
...
async def async_setup(hass, config):
    ...
    try:
        ...
        manager = MerossLocalManager(broker_address=conf.get(CONF_HOST), broker_port=conf.get(CONF_PORT),
                broker_ca_cert=conf.get(CONF_CERT), dev_cfg_file=conf.get(CONF_DEVICES))
